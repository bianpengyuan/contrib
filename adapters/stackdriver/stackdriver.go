...
// nolint: lll
//go:generate $GOPATH/src/istio.io/contrib/bin/mixer_codegen.sh -a adapters/stackdriver/config/config.proto -i adapters/stackdriver/config/ -x "-s=false -n stackdriver -t logentry -t tracespan -t metric -t edge"
...
import (
	...
	"istio.io/contrib/adapters/stackdriver/helper"
	"istio.io/contrib/adapters/stackdriver/log"
	sdmetric "istio.io/contrib/adapters/stackdriver/metric"
	"istio.io/contrib/adapters/stackdriver/trace"
...
func GetInfo() adapter.Info {
	...
	return adapter.Info{
		Name:        "stackdriver",
		Impl:        "istio.io/contrib/adapters/stackdriver",
