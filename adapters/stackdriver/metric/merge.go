...
func mergePoints(a, b *monitoring.TimeSeries) (*monitoring.TimeSeries, error) {
	...
	case *monitoring.TypedValue_Int64Value:
		...
		a.Points[0].Value = &monitoring.TypedValue{Value: &monitoring.TypedValue_Int64Value{av.Int64Value + bv.Int64Value}}
	case *monitoring.TypedValue_DoubleValue:
		...
		a.Points[0].Value = &monitoring.TypedValue{Value: &monitoring.TypedValue_DoubleValue{av.DoubleValue + bv.DoubleValue}}
